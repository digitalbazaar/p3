...
config.financial.transaction.creditPaymentDuePeriod = 1000 * 60 * 60 * 5;
...
config.financial.account.worker.expiration = 1000 * 60 * 60 * 24;
...
// shared salt for unique payment token IDs
config.financial.sharedPaymentTokenSalt =
  '23wVGewfubiduMybjHmBseKVsAJPRucq3y9xoJf7vcJc4jWUtm';
