  ...
  async.waterfall([
    function(callback) {
      payswarm.identity.checkPermission(
        actor, PERMISSIONS.ACCOUNT_CREATE,
...
api.getIdentityAccounts = function(actor, identityId, callback) {
  async.waterfall([
    function(callback) {
      payswarm.identity.checkPermission(
        actor, PERMISSIONS.ACCOUNT_ACCESS, {resource: identityId}, callback);
    },
    function(callback) {
...
api.getAccount = function(actor, id, callback) {
  async.waterfall([
    ...
    function(account, meta, callback) {
      payswarm.identity.checkPermission(
        actor, PERMISSIONS.ACCOUNT_ACCESS,
...
api.updateAccount = function(actor, account, callback) {
  async.waterfall([
    function(callback) {
      payswarm.identity.checkPermission(
        actor, PERMISSIONS.ACCOUNT_EDIT, {
          resource: account,
          translate: 'owner',
