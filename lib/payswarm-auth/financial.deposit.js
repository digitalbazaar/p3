 ...
 * then payswarm.financial.updateAccountBalanceSnapshot() must first be
 * called on the account. Its return value (in its callback) can be used
 * to determine the maximum deposit amount permitted.
 *
