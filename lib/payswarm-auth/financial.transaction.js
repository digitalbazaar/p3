      ...
      payswarm.db.collections.account.findOne(
        {id: payswarm.db.hash(src)}, {
          ...
          if(balance.compareTo(minBalance) < 0) {
            ...
            // options.deposit/optinns.triggered is given or (instant transfer
            // feature is enabled, contract amount is less than minimum instant
            // transfer amount, and a account backup source is available)
