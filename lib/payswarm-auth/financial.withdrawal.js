...
api.signWithdrawal = function(actor, withdrawal, options, callback) {
  ...
  async.auto({
    ...
    addGatewayPayees: ['getDestination', function(callback, results) {
      // set destination
      withdrawal.destination = results.getDestination;
    ...
    sign: ['getSource', 'addGatewayPayees', 'getId',
      function(callback, results) {
        ...
        var payees = payswarm.tools.sortPayees(withdrawal.payee);
        payswarm.tools.createTransfers(withdrawal, sourceId, payees);
  ...
  async.auto({
    ...
    creditDestination: ['authorize', function(callback, results) {
      ...
      gateway.creditWithdrawalDestination(withdrawal, function(err, result) {
        ...
        // annotate withdrawal w/gateway info
