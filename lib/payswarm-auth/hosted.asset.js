 ...
 *
 * urn:hostedAssetPublicKey:<db hash of asset's content url>
 *
...
api.setAssetContentPublicKey = function(actor, assetId, publicKey, callback) {
  async.waterfall([
    ...
    function(asset, callback) {
      ...
      publicKey.id = getAssetContentPublicKeyId(asset.assetContent);
...
api.getAssetContentPublicKey = function(asset, callback) {
  async.waterfall([
    ...
    function(asset, callback) {
      // generate ID for public key
      var id = getAssetContentPublicKeyId(asset.assetContent);
