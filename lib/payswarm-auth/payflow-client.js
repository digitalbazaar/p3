...
api.PayflowClient.prototype.charge = function(
  ...
  var self = this;
  try {
    var req = self.createChargeRequest(source, amount, options);
  }
  catch(ex) {
    return callback(ex);
  }
...
api.PayflowClient.prototype.hold = function(
  ...
  var self = this;
  try {
    var req = self.createHoldRequest(source, amount, options);
  }
  catch(ex) {
    return callback(ex);
  }
...
api.PayflowClient.prototype.capture = function(
  ...
  var self = this;
  try {
    var req = self.createCaptureRequest(source, amount, options);
  }
  catch(ex) {
    return callback(ex);
  }
