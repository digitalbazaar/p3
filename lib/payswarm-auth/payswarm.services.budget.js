...
function addServices(app, callback) {
  payswarm.docs.annotate.post('/i/:identity/budgets', {
    public: true,
    group: 'Budgets',
    rateLimit: 0,
    authentication: true,
    ...
    exampleResponse: {
      ...
      id: 'https://dev.payswarm.com/i/john/budgets/1.2.67.1',
      type: 'psa:Budget',
      owner: 'https://dev.payswarm.com/i/john',
      label: 'Movies',
      source: 'https://dev.payswarm.com/i/john/accounts/primary',
      amount: '10.00',
      balance: '10.00'
    },
    description: 'Creates a budget that may be associated with a vendor ' +
      'in order to limit spending by the buyer, or limit automatic ' +
      'purchases by the vendor.'
  });
