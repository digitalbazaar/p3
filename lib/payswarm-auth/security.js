...
var BedrockError = bedrock.module('tools').BedrockError;

// extend bedrock security
var api = bedrock.module('security');
module.exports = api;

// FIXME: bedrock functions won't use locally-configured jsonld for
// payswarm ... need to add dependency injection to bedrock security for that
