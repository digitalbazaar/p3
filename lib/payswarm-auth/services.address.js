...
function addServices(app, callback) {
  ...
  app.server.post('/i/:identity/regulatory-address', ensureAuthenticated,
    validate('services.address.postRegulatoryAddress'),
    _postRegulatoryAddress);
...
function _postRegulatoryAddress(req, res, next) {
  payswarm.identityAddress.setIdentityRegulatoryAddress(
    req.user.identity, {
      id: payswarm.identity.createIdentityId(req.params.identity),
