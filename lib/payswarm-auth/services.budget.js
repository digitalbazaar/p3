    ...
    function(req, res, next) {
      ...
      async.waterfall([
        ...
        function(budgetId, callback) {
          ...
          if('psaRefreshInterval' in req.body) {
            budget.psaRefreshInterval = req.body.psaRefreshInterval;
          }
          if('psaValidityInterval' in req.body) {
            budget.psaValidityInterval = req.body.psaValidityInterval;
          }
