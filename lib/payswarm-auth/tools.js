...
api.PaySwarmError.prototype.isType = function(type) {
  return this.name === type;
}
// check type of this error or one of it's causes
api.PaySwarmError.prototype.hasType = function(type) {
  return this.isType(type) || this.hasCauseOfType(type);
}
// check type of error cause or one of it's causes
api.PaySwarmError.prototype.hasCauseOfType = function(type) {
  if(this.cause && this.cause instanceof api.PaySwarmError) {
...
api.getDefaultJsonLdContextUrl = function() {
  return payswarm.constants.CONTEXT_URL;
};
...
api.getDefaultJsonLdContext = function() {
  return payswarm.constants.CONTEXT;
};
...
api.getDefaultJsonLdFrames = function() {
  return payswarm.constants.FRAMES;
};
