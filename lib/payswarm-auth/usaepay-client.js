...
api.USAePayClient.prototype.tokenize = function(account, callback) {
  ...
  token.bankAccountType = account.bankAccountType || 'Checking';
      ...
      var args = {
        ...
        CustomerData: {
          BillingAddress: {
            ...
            City: address.streetLocality,
            State: address.streetRegion,
...
function _runTransaction(
  ...
  if(options.transactionId) {
    // hash transaction ID to fit within 64 chars
  ...
  var args = {
    ...
    Parameters: {
      ...
      Details: {
        Amount: amount,
        Currency: 'USD',
        OrderID: txnId || undefined,
        Description: options.transactionId || undefined
      }
    }
  };
