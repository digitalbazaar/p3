 ...
 */
api.USAePay.prototype.init = function(callback) {
 ...
 */
api.USAePay.prototype.verify = function(source, options, callback) {
  ...
  var args = {
    ...
    Params: {
      ...
      CheckData: {
        Routing: source.bankRouting,
        Account: source.bankAccountNumber,
 ...
 * @param callback(err, res) called once the operation completes.
 */
api.USAePay.prototype.charge = function(source, amount, options, callback) {
  if(typeof options === 'function') {
    callback = options;
    options = {};
  }
 ...
 * @param callback(err, res) called once the operation completes.
 */
api.USAePay.prototype.credit = function(
 ...
 * @param callback(err, res) called once the operation completes.
 */
api.USAePay.prototype.inquire = function(txn, callback) {
  var self = this;
  var args = {
    Token: _createSecurityToken(self.options.sourceKey, options),
