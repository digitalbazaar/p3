...
// permit custom account balances for testing (*ONLY* true in dev mode!)
config.financial.allowCustomBalance = true;
...
// 2 minute transaction worker expiration
config.financial.transactionWorkerExpiration = 1000 * 60 * 2;
