...
api.init = function(app, callback) {
  ...
  // FIXME: use callback
  payswarm.common.security.signJsonLd(obj, privateKey, publicKey['@id']);
  //console.log('SIGNED: ' + JSON.stringify(obj, null, 2));
  // FIXME: use callback
  assert(payswarm.common.security.verifyJsonLd(obj, publicKey));
  callback(null);*/
  ...
  async.waterfall([
    function encrypt(callback) {
      payswarm.common.security.encryptJsonLd(obj, publicKey, callback);
    },
    function decrypt(msg, callback) {
      payswarm.common.security.decryptJsonLd(msg, privateKey, callback);
    },
  ...
  */
  ...
  /* Money test
  var d = new payswarm.common.Money(2);
  var x = new payswarm.common.Money("123456.123456789012345678901234567890");
  console.log("d * x = " + d.multiply(x));
  // Output: d * x = 7470299375046812977089832214047022056.555930270554343863089286012030

  var two = new payswarm.common.Money('2');
