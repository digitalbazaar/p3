...
<div id="tos" class="block-inline w47 mr1">
   <div id="tos-toc">
      ...
      to participate with on the PaySwarm Developer Sandbox. Before using the 
      PaySwarm Developer Sandbox (The "Service"), please read and familiarize 
      ...
      the Service:</p>
      <ul>
         <li>IRC: <a href="irc://irc.freenode.net/payswarm">#payswarm</a> 
         channel on <a href="http://freenode.net/">FreeNode</a></li>
   ...
   <div id="tos-overview">
      ...
      <p>The Service offers a sandboxed set of web pages and an API for
      creating and deleting accounts, managing financial deposits, purchases,
      payments and withdrawals. The Service is typically used to develop 
      software for the set of PaySwarm standards. 
      </p>
      ...
      <p>The Service is a fully sandboxed environment, meaning that all 
      accounts and financial transactions are not connected to any external
      system. At no point will Digital Bazaar be expected to disburse funds
      for payment or any other sort of financial outcome caused by operation 
      of the sandboxed environment. All money on this system is fake and
      only tracked for the purposes of developing and testing interoperable 
      PaySwarm systems.</p>
      ...
      or beta releases of the 
      PaySwarm software and cannot guarantee that there will not be bugs in the 
      software. While the staff of Digital Bazaar will endeavor to fix the bugs 
      as quickly as possible, we cannot guarantee that there will not be a 
      breach of information at some point. Since this is a sandboxed 
      environment, developers are urged to not use real credit card information 
      or other financially or personally sensitive data.</p>
