...
<html version="XHTML+RDFa 1.0" xmlns="http://www.w3.org/1999/xhtml"
   ...
   xmlns:ps="https://w3id.org/payswarm#">
<head>
  <meta http-equiv="Content-Type" content="text/html;charset=utf-8" /> 
  <meta property="dc:format" content="text/html" />
  <title>Personal Use License for Articles</title> 
</head>
<body about="" typeof="ps:License" 
      property="ps:licenseTemplate" datatype="rdf:XMLLiteral">
<h1>Personal Use License for Articles</h1>
...
<ol>
<li>This license is for personal use only. Personal use means non-commercial 
...
<li>Title and ownership, and all rights now and in the future, of and for the 
article(s) remain exclusively with the content owner.
</li>
<li>There are no warranties, express or implied. The articles(s) are provided 
'as is.'</li>
<li>Neither the writer, payment processing service, nor hosting service will 
