  ...
  <tbody>
    <tr data-ng-repeat="row in table" data-ng-hide="row.hidden">
      ...
      <td data-ng-switch="getRowType(row)" data-ng-click="toggleDetails(row)">
        <span data-ng-switch-when="deposit" class="name"><i class="icon-plus"></i> Deposit <span data-ng-show="!(row.settled || row.voided)" class="label label-info">Pending</span><span data-ng-show="row.voided" class="label label-important">Voided</span><div data-ng-show="row.detailsVisible"><a href="{{row.id}}">View detailed deposit...</a></div></span>
        ...
        <span data-ng-switch-when="withdrawal" class="name"><i class="icon-minus"></i> Withdrawal <span data-ng-show="!(row.settled || row.voided)" class="label label-info">Pending</span><span data-ng-show="row.voided" class="label label-important">Voided</span><div data-ng-show="row.detailsVisible"><a href="{{row.id}}">View detailed withdrawal...</a></div></span>
